...
public class AdminController {
    ...
    public ResponseEntity<Product> createProduct(
        ...
        System.out.println("=== 🛠️ CREATE PRODUCT API CALLED ===");
        ...
        try {
            ...
            if (image != null && !image.isEmpty()) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    // Vẫn tiếp tục tạo product không có ảnh
                }
            } else {
                System.out.println("📸 No image provided, continuing without image");
            }

            // Convert price
            BigDecimal priceDecimal = BigDecimal.valueOf(price);
            System.out.println("💰 Price converted to BigDecimal: " + priceDecimal);

            System.out.println("🔄 Calling productService.createProduct()...");
            Product product = productService.createProduct(
                    name, description, priceDecimal,
